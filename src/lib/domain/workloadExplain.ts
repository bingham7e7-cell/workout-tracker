...
export const HOW_IT_WORKS_PARAGRAPHS: string[] = [
  ...
  `Recent training counts more than older training: a set's contribution starts at 100% right when the workout finishes and halves every ${RECENCY_HALF_LIFE_HOURS} hours (2 days), fading out smoothly rather than dropping off a cliff after some fixed number of days.`,
  "A muscle's score is the sum of every recent working set's contribution: effort × primary-or-secondary credit × how recently it happened.",
];
